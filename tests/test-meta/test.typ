...
#assert.eq(validate(SPEC, result-unwrap(spec-parse(RESULT(int)))), ok(result-unwrap(spec-parse(RESULT(int)))))
...
#assert.eq(validate(SPEC, spec-dictionary(str, spec-array(int))), ok(spec-dictionary(str, spec-array(int))))
